...
void setup() {
  ...
  for (int i = 0; i < 10; i++) {
    count += 1;
    Serial.print(" init offset_b :  "); Serial.println(scale.value_b());
...
void loop() {
  ...
  Serial.print(" | raw-offset: "); Serial.print(val2 - 8399012);
  Serial.print(" | cal : ");  Serial.print((val2 - 8399012) / 112.12f, 1);
