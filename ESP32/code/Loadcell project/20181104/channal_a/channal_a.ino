...
double average(int count) {
  ...
  for (int i = 0; i < count ; i++) {
    value += (scale.value() - offset) / PART_ONE_CHANNAL_A_SCALE;
  }
...
void setup() {
  ...
  for (int i = 0; i < 10; i++) {
    count += 1;
    Serial.print(" init offset :  "); Serial.println(scale.value());
    offset += scale.value();
  }
  offset  = offset / count;
  count = 0;
...
void loop() {
  ...
  val2 = scale.value();
  Serial.print("offset a ==> "); Serial.print(offset);
  Serial.print(" | raw value 1: "); Serial.print(val2);
  Serial.print(" | raw-offset: "); Serial.print(val2 - offset);
  Serial.print(" | cal : ");  Serial.print((val2 - offset) / PART_ONE_CHANNAL_A_SCALE, 1);
